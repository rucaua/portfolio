<template>
  <section class="container mx-auto py-20 flex flex-col lg:flex-row flex-wrap justify-between">
    <div v-for="item in data" :key="item.name" class="w-full lg:w-6/12 -mx-4">
      <div class="px-4">
